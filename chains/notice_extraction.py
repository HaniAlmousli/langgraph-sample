...
@traceable(name="notice_parser_chain")
def create_notice_parser_chain():
    """Create the notice parser chain with tracing"""
    return (
        info_parse_prompt
        | notice_parser_model.with_structured_output(NoticeEmailExtract)
    )

NOTICE_PARSER_CHAIN = create_notice_parser_chain()
