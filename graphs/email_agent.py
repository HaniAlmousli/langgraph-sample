...
@tool
# @traceable(name="send_wrong_email_notification")
...
@tool
# @traceable(name="extract_notice_data")
def extract_notice_data(
    email: str, escalation_criteria: str) -> NoticeEmailExtract:
    """
...
@tool
# @traceable(name="determine_email_action")
...
# @traceable(name="call_agent_model")
